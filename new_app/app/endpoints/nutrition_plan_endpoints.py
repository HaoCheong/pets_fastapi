...
@router.post("/nutrition_plan/", response_model=schemas.NutritionPlanReadWR, tags=['Nutrition Plans'])
def create_nutrition_plan(nutrition_plan: schemas.NutritionPlanCreate, db: SessionDep):
...
def update_nutrition_plan(nutrition_plan_id: int, new_nutrition_plan: schemas.NutritionPlanUpdate, db: SessionDep):
